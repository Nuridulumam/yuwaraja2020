...
<!-- Query-->
 ...
 error_reporting(E_ALL^(E_NOTICE| E_WARNING));
  ...
  if($cek_status==1 or $cek_status==2){
  $kode=$_GET['kode'];
 $data =$mysqli->query("select*from mahasiswa where nim='$kode'");
...
<div class="content-wrapper">
    ...
    <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Data Table Cluster&nbsp;&nbsp;
          </div>
        <div class="card-body">
    ...
    <form role="form" class="form-horizontal" method="post" action="editcluster_proses.php?kode=<?php echo $datacluster1['nim']?>" enctype="multipart/form-data">
   <div class="form-group">
    <label>Nama Lengkap</label>
    <input type="text" name="nama" class="form-control" value="<?php echo $datacluster1['nama'] ?>">
   </div>
   <div class="form-group">
    <label>Nim</label>
    <input type="text" name="nim" class="form-control" value="<?php echo $datacluster1['nim'] ?>" disabled="disabled">
   </div>
   <div class="form-group">
    <label>Jurusan</label>
  ...
  <select class="form-control" id="jurusan" name="jurusan">
   ...
   <option value="<?php echo $datacluster1['jurusan']?>"><?php echo $datacluster1['jurusan']?></option>
        ...
        <option value="Business Digital dan E-Commerce">Business Digital dan E-Commerce</option>
        <option value="Perbankan">Perbankan</option>
        <option value="Perpajakan">Perpajakan</option>
        <option value="Akuntansi Terapan">Akuntansi Terapan</option>
        <option value="Public Relations">Public Relations</option>
        <option value="Administrasi Kantor dan Sekretari">Administrasi Kantor dan Sekretari</option>
        <option value="Perpustakaan dan Arsip">Perpustakaan dan Arsip</option>
        <option value="Administrasi Hukum">Administrasi Hukum</option>
  ...
  <option value="<?php echo $datacluster1['cluster'] ?>"><?php echo $datacluster1['cluster'] ?></option> 
       <?php 
	  ...
	  <div class="form-group">
    <label>PK2MABA </label>
    <input type="text" name="pkk1" class="form-control"value="<?php echo $datacluster1['PK01'] ?>">
   </div>
   <div class="form-group">
    <label>Krima 1</label>
    <input type="text" name="k1" class="form-control"value="<?php echo $datacluster1['P01'] ?>">
   </div>
   <div class="form-group">
    <label>Krima 2</label>
    <input type="text" name="k2" class="form-control"value="<?php echo $datacluster1['P02'] ?>">
   </div>
   <div class="form-group">
    <label>Krima 3</label>
    <input type="text" name="k3" class="form-control"value="<?php echo $datacluster1['P03'] ?>">
   </div>
   <div class="form-group">
    <label>Krima 4</label>
    <input type="text" name="k4" class="form-control"value="<?php echo $datacluster1['P04'] ?>">
   </div>
   <div class="form-group">
    <label>Krima 5</label>
    <input type="text" name="k5" class="form-control"value="<?php echo $datacluster1['P05'] ?>">
   </div>
   <div class="form-group">
    <label>Krima 6</label>
    <input type="text" name="k6" class="form-control"value="<?php echo $datacluster1['P06'] ?>">
   </div>
     <div class="form-group">
    <label>Krima 7</label>
    <input type="text" name="k7" class="form-control"value="<?php echo $datacluster1['P07'] ?>">
   </div>
   <div class="form-group">
    <label>LKMM</label>
    <input type="text" name="lkmm" class="form-control"value="<?php echo $datacluster1['LKMM'] ?>">
   </div>
    <div class="form-group">
    <label>Minus</label>
    <input type="text" name="minus" class="form-control"value="0">
   </div>
       <div class="form-group">
    <label>Total</label>
    <input type="text" name="total" class="form-control" value="<?php echo $datacluster1['total']?>" >
   </div>
   <div class="form-group">
    <label>kesalahan</label>
    <textarea name="kesalahan" class="ckeditor"><?php echo $datacluster1['kesalahan'] ?></textarea>
   </div>
