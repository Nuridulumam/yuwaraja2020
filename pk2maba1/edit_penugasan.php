...
<!-- Query-->
 ...
 error_reporting(E_ALL^(E_NOTICE| E_WARNING));
  ...
  if($cek_status==1 or $cek_status==3){
  $kode=$_GET['kode'];
 $data =$mysqli->query("select*from penugasan where id='$kode'");
...
<div class="content-wrapper">
  ...
  <form role="form" class="form-horizontal" method="post" action="edit_penugasan_proses.php?kode=<?php echo $datacluster1['id']?>" enctype="multipart/form-data">
   <div class="form-group">
    <label>Judul</label>
    <input type="text" name="judul" class="form-control" value="<?php echo $datacluster1['judul']?>">
   </div>
   <div class="form-group">
    <label>Tanggal Penugasan</label>
    <input type="date" name="tanggal" class="form-control" value="<?php echo $datacluster1['tanggal']?>">
   </div>
   
  
   <div class="form-group">
    <label>Deskripsi</label>
    <textarea name="deskripsi" class="ckeditor"><?php echo $datacluster1['deskripsi'] ?></textarea>
   </div>
