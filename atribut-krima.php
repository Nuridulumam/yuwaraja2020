...
<?php
        ...
        <div class="container">
            ...
            <div class="col-md-2 p0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="http://yuwaraja.vokasi.ub.ac.id/"><img src="images/2020/brandlogo.png" height="56px" style="margin-top: -20px;" alt=""></a>
                </div>
            </div>
            ...
            <div class="col-md-10 p0">
                <div class="collapse navbar-collapse" id="min_navbar">
                    <ul class="nav navbar-nav navbar-right">
                       ...
                       <li><a href="404.html">Penilaian</a></li>
    ...
    <section class="banner_area" data-stellar-background-ratio="0.5">
        <h2>ATRIBUT MAHASISWA</h2>
        <ol class="breadcrumb">
            <li><a href="index.html">Home</a></li>
            <li><a href="#" class="active">Atribut</a></li>
             <li><a href="#" class="active">Top Posts</a></li>
        </ol>
    </section>
    <!-- End Banner area -->
        ...
        <div class="container">
            <div class="row m0 blog_row">
                <div class="col-sm-8 main_blog">
                    <img src="images/blog/atribut.jpg" alt="">
                    <div class="col-xs-1 p0">
                       <div class="blog_date">
                           <img src="images/2020/logotab.png" width="80%"> 
                        </div>
                  </div>
                    <div class="col-xs-11 blog_content"  style="z-index:1000">
                        <a class="blog_heading" href="#">PERATURAN ATRIBUT PESERTA KEJUARAAN YUWARAJA</a>
                        <a class="blog_admin" href="#"><i class="fa fa-user" aria-hidden="true"></i>BIT PKKMB VOKASI</a>
                        <ul class="like_share">
                          
                            <li><a href="#"><i class="fa fa-heart" aria-hidden="true"></i>&nbsp;301299</a></li>
                            <li><a href="#"><i class="fa fa-calendar" aria-hidden="true"></i>&nbsp;2020-10-23</a></li>
                        </ul>

                        <div class="navigasi">
                            <ul class="nav nav-tabs">
                                <!-- <li role="presentation"><a class="navig" href="#atb1" aria-controls="atb1" role="tab" data-toggle="tab">KRIMA 1</a></li>
                                <li role="presentation"><a class="navig" href="#atb2" aria-controls="atb2" role="tab" data-toggle="tab">KRIMA 2</a></li>
                                <li role="presentation"><a class="navig" href="#atb3" aria-controls="atb3" role="tab" data-toggle="tab">KRIMA 3</a></li>
                                <li role="presentation"><a class="navig" href="#atb4" aria-controls="atb4" role="tab" data-toggle="tab">KRIMA 4</a></li> -->
                                <li role="presentation" class="active" ><a class="navig" href="#yuw1" aria-controls="yuw1" role="tab" data-toggle="tab"> KEJUARAAN YUWARAJA</a></li>
                            </ul>
                        </div>
                        <div class="tab-content">
                            <!-- <?php $kr1 = 1;
                            $data = $mysqli->query("SELECT deskripsi FROM atribut WHERE id=$kr1");
                            $datatugas = mysqli_fetch_assoc($data);
                            echo '<div role="tabpanel" class="tab-pane fade" id="atb1">' . $datatugas['deskripsi'] . '
                            </div>';
                            ?>
                            <?php $kr1 = 2;
                            $data = $mysqli->query("SELECT deskripsi FROM atribut WHERE id=$kr1");
                            $datatugas = mysqli_fetch_assoc($data);
                            echo '<div role="tabpanel" class="tab-pane fade" id="atb2">' . $datatugas['deskripsi'] . '
                            </div>';
                            ?>
                            <?php $kr1 = 3;
                            $data = $mysqli->query("SELECT deskripsi FROM atribut WHERE id=$kr1");
                            $datatugas = mysqli_fetch_assoc($data);
                            echo '<div role="tabpanel" class="tab-pane fade" id="atb4">' . $datatugas['deskripsi'] . '
                            </div>';
                            ?>
                            <?php $kr1 = 4;
                            $data = $mysqli->query("SELECT deskripsi FROM atribut WHERE id=$kr1");
                            $datatugas = mysqli_fetch_assoc($data);
                            echo '<div role="tabpanel" class="tab-pane fade" id="atb3">' . $datatugas['deskripsi'] . '
                            </div>';
                            ?> -->
                            <?php $kr1 = 2;
                            $data = $mysqli->query("SELECT deskripsi FROM atribut WHERE id=$kr1");
                            $datatugas = mysqli_fetch_assoc($data);
                            echo '<div role="tabpanel" class="tab-pane fade in active" id="yuw1">' . $datatugas['deskripsi'] . '
                            </div>';
                            ?>
                        </div>
                    ...
                    <div class="resent">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <a href="peraturan.html">Dapatkan informasi seputar peraturan KRIMA Vokasi UB 2020</a>
                                <h6>PERATURAN KRIMA </h6>
                            </div>
                        </div>
                        <div class="media">
                            <div class="media-left">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <a href="#">Kuesioner Penyampaian Informasi KRIMA VOKASI 2020</a>

                                <h6>KUESIONER PKKMABA </h6>
                            </div>
                        </div>
                        <div class="media">
                            <div class="media-left">
                            ...
                            <div class="media-body">
                                <a href="#">Unduh Jingle Vokasi UB 2020</a>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <a href="spv.html">Dapatkan informasi kontak Divisi SPV KRIMA Vokasi UB 2020</a>
                                <h6>DAFTAR SPV</h6>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="footer_row row">
                <div class="col-md-3 col-sm-6 footer_about">
                    ...
                    <img src="images/2020/brandlogo.png" height="64px" alt="">
                    <p>Website seputar seluruh informasi penugasan serta penilaian PKKMABA Vokasi Universitas Brawijaya</p>
                </div>
                <div class="col-md-3 col-sm-6 footer_about quick">
                    ...
                    <ul class="quick_link">
                      ...
                      <li><a href="404.html"><i class="fa fa-chevron-right"></i>Penilaian</a></li>
                 ...
                 <div class="col-md-3 col-sm-6 footer_about quick">
                    ...
                    <center><font color="#FFD700">Yuwaraja Vokasi</center></li></font>
                      ...
                      <center><font color="#FFD700">@vgh3838g</center></font></li>
                      <li><a href="http://yuwaraja.vokasi.ub.ac.id/" target="_blank"><i class="fab fa-internet-explorer"></i></i>Website</a><br>
                      <center><font color="#FFD700">yuwaraja.vokasi.ub.ac.id</center></font></li></font>
                  </ul>
                </div>
                <div class="col-md-3 col-sm-6 footer_about">
                    <h2>CONTACT US</h2>
