                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="renovation">
                            <div class="renovation_content">
                                ...
                                <!-- <a class="tittle" href="nilaicluster.php?kode=<?php echo $no ?>">Cluster <?php echo  $no ?></a> -->
                                <a class="tittle" href="404.html">Cluster <?php echo  $no ?></a>
                                <div class="date_comment">
                                    <a href="#"> <i class="fa fa-user" aria-hidden="true"></i>&nbsp;BIT PKKMB VOKASI</a>

                                </div>
                                <p>Berikut data penilaian Cluster <?php echo $no ?> bagi mahasiswa baru </p>
