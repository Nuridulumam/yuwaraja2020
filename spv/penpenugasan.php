                                ...
                                <div class="grid_3 grid_5">
                                    ...
                                    <div class="but_list">
                                        <div class="col-md-12 page_1">
                                            <p>Data Penilaian Penugasan Mahasiwa Baru Vokasi 2020 Cluster <?= $datacluster1['cluster'] ?></p>
                                            <div class="card-body">
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#myModaledit<?php echo $datacluster1['id_maba'] ?>">Edit</button>
                                                                        <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#myModaleditt<?php echo $datacluster1['id_maba'] ?>">Alpha</button>
                                                                        <!-- </a> -->

                                                                    </td>
                                                                </tr>
                                                                <div class="modal fade" id="myModaledit<?php echo $datacluster1['id_maba'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h4><?php echo $datacluster1['nama'] ?> | <?php echo $datacluster1['nim'] ?></h4>
                                                                            ...
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <form role="form" class="form-horizontal" method="POST" action="updatepenugasan.php" accept-charset="utf-8" enctype="multipart/form-data">
                                                                                    <!-- ambil id maba -->
                                                                                    <input type="hidden" name="id" value="<?php echo $datacluster1['id_maba'] ?>">

                                                                                    <div class="col-md-12 form-group1 group-mail">
                                                                                        <label class="control-label">Nilai PKKMB 1</label>
                                                                                        <input type="text" placeholder="PKKMB 1" name="pkkmb1" value="<?php echo $datacluster1['n_pkkmb1'] ?>" required="">

                                                                                    </div>
                                                                                    <div class="clearfix"> </div>
                                                                                    <div class="col-md-12 form-group1 group-mail">
                                                                                        <label class="control-label">Nilai PKKMB 2</label>
                                                                                        <input type="text" placeholder="PKKMB 2" name="pkkmb2" value="<?php echo $datacluster1['n_pkkmb2'] ?>">
                                                                                    ...
                                                                                    <div class="col-md-12 form-group1 group-mail">
                                                                                        ...
                                                                                        <input type="text" placeholder="Krima1" value="<?php echo $datacluster1['n_k1'] ?>" name="n_k1">
                                                                                    </div>

                                                                                    <div class="clearfix"> </div>
                                                                                    <div class="col-md-12 form-group1 group-mail">
                                                                                        <label class="control-label">Nilai Krima 2</label>
                                                                                        <input type="text" placeholder="Krima2" value="<?php echo $datacluster1['n_k2'] ?>" name="n_k2">
                                                                                    </div>

                                                                                    <div class="clearfix"> </div>
                                                                                    <div class="col-md-12 form-group1 group-mail">
                                                                                        <label class="control-label">Nilai Krima 3</label>
                                                                                        <input type="text" value="<?php echo $datacluster1['n_k3'] ?>" name="n_k3">
                                                                                    </div>

                                                                                    <div class="clearfix"> </div>
                                                                                    <div class="col-md-12 form-group1 group-mail">
                                                                                        <label class="control-label">Nilai Krima 4</label>
                                                                                        <input type="text" value="<?php echo $datacluster1['n_k4'] ?>" name="n_k4">
                                                                                    </div>

                                                                                    <div class="clearfix"> </div>
                                                                                    <div class="col-md-12 form-group1 group-mail">
                                                                                        <label class="control-label">Nilai Kejuaraan</label>
                                                                                        <input type="text" value="<?php echo $datacluster1['n_k5'] ?>" name="n_k5">
                                                                                    </div>
                                                                ...
                                                                <div class="modal fade" id="myModaleditt<?php echo $datacluster1['id_maba'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h4 class="modal-title"><?php echo $datacluster1['nama'] ?> | <?php echo $datacluster1['nim'] ?></h4>
              ...
              <label class="control-label">Cluster</label>
                                                                    ...
                                                                    <div class="clearfix"> </div> -->
                                                                                    ...
                                                                                    <div class="col-md-12 form-group1 group-mail">
                                                                                        ...
                                                                                        <input type="text" placeholder="Jumlah Alpha" name="minus" value="<?php echo $datacluster1['minus'] ?>" <?php if ($datacluster1['minus'] != null) {
                                                                                                                                                                                                    echo '';
                                                                                                                                                                                                } ?>>
                                                                                    ...
                                                                                    <div class="col-md-12 form-group">
                                                                                        <?php if ($datacluster1['minus'] == null) {
                                                                                            echo '<button type="submit" class="btn btn-primary">Submit</button>';
                                                                                        } elseif ($datacluster1['minus'] != null) {
                                                                                            echo '';
                                                                                        }
                                                                                        ?>
                    ...
                    <!---->
                    <div class="copy">
                        <p> &copy; 2020 Minimal. All Rights Reserved | Design by BIT PK2MABA Vokasi 2020 <span style="color: #fff">W3layouts</span> </p>
                    </div>
                </div>
                <div class="clearfix"> </div>
            </div>
