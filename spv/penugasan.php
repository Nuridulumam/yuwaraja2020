...
<h4>Data Penugasan Mahasiswa Baru Vokasi 2019</h4> 
     
       <div class="but_list">
	    <div class="col-md-12 page_1">
			<p>Data Penugasan Mahasiswa Baru Vokasi 2019</p>
 	...
 	<!---->
        ...
        <form>
            ...
            <div class="col-md-12 form-group1">
              <label class="control-label">Tanggal Penugasan</label>
              <input type="Date" placeholder="Tanggal Penugasan" required="">
           
            </div> <div class="clearfix"> </div>

            <div class="col-md-12 form-group1">
              <label class="control-label">Deksripsi</label>
              <textarea  placeholder="Deskripsi Penugasan....." required="">Deskripsi Penugasan.....</textarea>
