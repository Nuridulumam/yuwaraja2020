...
<body>
  ...
  $kode = $_GET['kode'];
  $kd = $_GET['kode'];
  $data = mysqli_query($koneksi, "SELECT * from tb_maba  where cluster='$kd' order by id_maba ASC");
  ...
  <section class="banner_area" data-stellar-background-ratio="0.5">
    <h2>penilaian cluster <?php echo $kode ?></h2>
    <ol class="breadcrumb">
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    <td><?= $no++ ?></td>
                    <!-- <td><?= $datacluster1['nim'] ?></td> -->
                    <td><?= $datacluster1['nama'] ?></td>
                    <td><?= $datacluster1['jurusan'] ?></td>
                    <td><?= $datacluster1['n_total'] ?></td>
                  </tr>
                <?php
  ...
  <footer class="footer_area">
    ...
    <div class="copyright_area">
      Copyright 2020 All rights reserved. Designed by <a href="#">BIT PKKMB VOKASI 2019</a>
    </div>
  </footer>
  <!-- End Footer Area -->
